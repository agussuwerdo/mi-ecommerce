...
$config['sess_driver'] = 'database';  // Use the 'database' driver for sessions
$config['sess_samesite'] = 'Lax';
$config['sess_cookie_name'] = 'ci_session_mi_ecommerce';  // Name of the session cookie
$config['sess_expiration'] = 7200;  // Session expiration time in seconds
$config['sess_save_path'] = 'ci_sessions';  // Table name where session data is stored
$config['sess_match_ip'] = FALSE;  // Whether to match session based on IP address
$config['sess_time_to_update'] = 300;  // Time (in seconds) to update the session ID
$config['sess_regenerate_destroy'] = FALSE;  // Destroy the old session when regenerating
